<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- User Notes -->
                    <x-nav-link :href="route('user.notes')" :active="request()->routeIs('user.notes')">
                        {{ __('My Notes') }}
                    </x-nav-link>
            ...
            <!-- Settings Dropdown (Authentication) -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- My Notes (Mobile) -->
            <x-responsive-nav-link :href="route('user.notes')" :active="request()->routeIs('user.notes')">
                {{ __('My Notes') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('user.notes')">
                    {{ __('My Notes') }}
                </x-responsive-nav-link>

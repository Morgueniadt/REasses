        ...
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6">
                ...
                <x-text-input
                    ...
                    name="password"
                    type="password"
                    class="mt-1 block w-3/4 bg-gray-800 text-gray-300 border-gray-600 focus:ring-red-500 focus:border-red-500"
            ...
            <div class="mt-6 flex justify-end">
                ...
                <x-danger-button class="ms-3 bg-red-600 hover:bg-red-500 text-white px-4 py-2 rounded">
                    {{ __('Delete Account') }}
                </x-danger-button>
            </div>
        </form>
